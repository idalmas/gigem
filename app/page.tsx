    ...
    <div className="d-flex flex-column min-vh-100" style={{ backgroundColor: '#E8F5E9' }}>
      ...
      <main className="flex-grow-1 d-flex flex-column justify-content-start pt-5">
        <div className="container">
          <h1 className="display-4 mb-4 fw-medium">Find your next job</h1>
          <a href="https://airtable.com/appXZDsIUpmia1Bbe/pagvf3CVZ3Hyb0zyd/form" className="btn btn-success btn-lg">
            Join the Waitlist
          </a>
        </div>
      </main>
